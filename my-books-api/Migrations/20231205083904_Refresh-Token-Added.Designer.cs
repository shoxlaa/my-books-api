...
namespace my_books_api.Migrations
{
    ...
    [Migration("20231205083904_Refresh-Token-Added")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("my_books_api.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("my_books_api.Data.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("my_books_api.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("my_books_api.Data.Models.RefreshToken", b =>
                {
                    b.HasOne("my_books_api.Data.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
